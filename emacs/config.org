...
- [[#configuration-for-vinilla-emacs][Configuration for vinilla Emacs]]
  ...
  - [[#dired-the-directory-editor][Dired, the directory editor]]
    - [[#use-external-ls-implementation][Use external ls implementation]]
    - [[#reuse-directory-buffer][Reuse directory buffer]]
- [[#enhance-editing-experience-with-third-party-packages][Enhance editing experience with third-party packages]]
  - [[#prerequisites][Prerequisites]]
    - [[#set-path-and-exec-path][Set $PATH and exec-path]]
    - [[#bootstrap-the-use-package-macro][Bootstrap the use-package macro]]
  - [[#general-configs-for-all-text-editing-tasks][General configs for all text editing tasks]]
    - [[#hints-for-prefixed-key-bindings][Hints for prefixed key bindings]]
    - [[#basic-completion-settings][Basic completion settings]]
    - [[#never-lose-the-point-again][Never lose the point again]]
    - [[#recording-undo-history][Recording undo history]]
- [[#org-mode][Org mode]]
